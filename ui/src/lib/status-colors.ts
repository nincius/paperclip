...
export const issueStatusIcon: Record<string, string> = {
  ...
  human_review: "text-teal-600 border-teal-600 dark:text-teal-400 dark:border-teal-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  human_review: "text-teal-600 dark:text-teal-400",
...
export const statusBadge: Record<string, string> = {
  ...
  human_review: "bg-teal-100 text-teal-800 dark:bg-teal-900/50 dark:text-teal-200",
